...
const SidebarContent = ({ onClose, d3Data, files, setFiles, complete, setComplete, ...rest }: SidebarProps) => {
  ...
  const handleSubmit = async (event: any) => {
    ...
    const res = await fetch('https://freestok.herokuapp.com/nitrate-cancer/run', requestOptions);
        ...
        <>
          ...
          <HStack p={2} mt={4} ml={3} mr={3}>
            <Button bg={'gray.200'} _hover={{ bg: 'gray.300' }}>
              <Link href='https://freestok.herokuapp.com/nitrate-cancer/report' isExternal>
                Open Report
              </Link>
